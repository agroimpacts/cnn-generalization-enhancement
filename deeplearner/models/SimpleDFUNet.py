...
class SimpleDFUNet(nn.Module):

    def __init__(self, n_classes, in_channels):
        super(SimpleDFUNet, self).__init__()

        self.n_classes = n_classes
        self.in_channels = in_channels

        filters = (64, 128, 256, 512, 1024, 1536)
        ...
        self.block6 = ConvBlock(filters[4], filters[5], num_conv_layers=1)  # [B, 1024, H/32, W/32]
        ...
        self.hd6_UT_hd5 = nn.ConvTranspose2d(filters[5], filters[4], kernel_size=4, stride=2, padding=1, dilation=1)

        # fusion(h1_PT_hd5, h2_PT_hd5, h3_PT_hd5, h4_PT_hd5, h5_Cat_hd5, hd6_UT_hd4)
        self.conv5d_1 = ConvBlock(filters[5] + filters[3], filters[4], num_conv_layers=2)
        ...
        self.hd6DimreductSt4 = nn.Conv2d(filters[5], filters[0], kernel_size=1, stride=1, padding=0, bias=False)
        ...
        self.conv4d_1 = ConvBlock(filters[4], filters[3], kernel_size=3, num_conv_layers=2)
        ...
        self.hd6DimreductSt3 = nn.Conv2d(filters[5], filters[0] // 2, kernel_size=1, stride=1, padding=0, bias=False)
        ...
        self.conv3d_1 = ConvBlock(filters[3], filters[2], kernel_size=3, num_conv_layers=2)
        ...
        self.hd6DimreductSt2 = nn.Conv2d(filters[5], filters[0] // 4, kernel_size=1, stride=1, padding=0, bias=False)
        ...
        self.conv2d_1 = ConvBlock(filters[2], filters[1], kernel_size=3, num_conv_layers=2)
        ...
        self.hd6DimreductSt1 = nn.Conv2d(filters[5], filters[0] // 8, kernel_size=1, stride=1, padding=0, bias=False)
        ...
        self.conv1d_1 = ConvBlock(filters[1], filters[0], kernel_size=3, num_conv_layers=2)
    ...
    def forward(self, inputs):
        ...
        hd5 = self.conv5d_1(torch.cat((h1_PT_hd5, h2_PT_hd5, h3_PT_hd5, h4_PT_hd5, h5_Cat_hd5, hd6_UT_hd5), 1)) #[B, 1024, 16, 16]
        ...
        hd4 = self.conv4d_1(torch.cat((h1_PT_hd4, h2_PT_hd4, h3_PT_hd4, h4_Cat_hd4, hd5_UT_hd4, hd6_UT_hd4), 1)) #[B, 512, 32, 32]
        ...
        hd6_UT_hd3 = hd6_UT_hd3 = self.hd6_UT_hd3_conv(self.hd6_UT_hd3(self.hd6DimreductSt3(hd6)))  #[B, 32, 64, 64]
        hd3 = self.conv3d_1(torch.cat((h1_PT_hd3, h2_PT_hd3, h3_Cat_hd3, hd4_UT_hd3, hd5_UT_hd3, hd6_UT_hd3), 1)) #[B, 256, 64, 64]
        ...
        hd2 = self.conv2d_1(torch.cat((h1_PT_hd2, h2_Cat_hd2, hd3_UT_hd2, hd4_UT_hd2, hd5_UT_hd2, hd6_UT_hd2), 1)) #[B, 128, 128, 128]
        ...
        hd1 = self.conv1d_1(torch.cat((h1_Cat_hd1, hd2_UT_hd1, hd3_UT_hd1, hd4_UT_hd1, hd5_UT_hd1, hd6_UT_hd1), 1)) #[B, 64, 256, 256]
